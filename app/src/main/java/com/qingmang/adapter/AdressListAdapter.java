...
public class AdressListAdapter extends BaseQuickAdapter<Message.DataBean.ContentBean, BaseViewHolder> {


    public AdressListAdapter(@Nullable List<Message.DataBean.ContentBean> data) {
