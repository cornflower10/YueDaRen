...
public class Banner extends RelativeLayout {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        TypedArray array = getContext().obtainStyledAttributes(attrs, com.yyydjk.library.R.styleable.BannerLayoutStyle, defStyle, 0);
        selectedIndicatorColor = array.getColor(com.yyydjk.library.R.styleable.BannerLayoutStyle_selectedIndicatorColor, selectedIndicatorColor);
        unSelectedIndicatorColor = array.getColor(com.yyydjk.library.R.styleable.BannerLayoutStyle_unSelectedIndicatorColor, unSelectedIndicatorColor);

        int shape = array.getInt(com.yyydjk.library.R.styleable.BannerLayoutStyle_indicatorShape, Shape.oval.ordinal());
        ...
        selectedIndicatorHeight = (int) array.getDimension(com.yyydjk.library.R.styleable.BannerLayoutStyle_selectedIndicatorHeight, selectedIndicatorHeight);
        selectedIndicatorWidth = (int) array.getDimension(com.yyydjk.library.R.styleable.BannerLayoutStyle_selectedIndicatorWidth, selectedIndicatorWidth);
        unSelectedIndicatorHeight = (int) array.getDimension(com.yyydjk.library.R.styleable.BannerLayoutStyle_unSelectedIndicatorHeight, unSelectedIndicatorHeight);
        unSelectedIndicatorWidth = (int) array.getDimension(com.yyydjk.library.R.styleable.BannerLayoutStyle_unSelectedIndicatorWidth, unSelectedIndicatorWidth);

        int position = array.getInt(com.yyydjk.library.R.styleable.BannerLayoutStyle_indicatorPosition, Position.centerBottom.ordinal());
        for (Position position1 : Position.values()) {
            if (position == position1.ordinal()) {
                indicatorPosition = position1;
            }
        }
        indicatorSpace = (int) array.getDimension(com.yyydjk.library.R.styleable.BannerLayoutStyle_indicatorSpace, indicatorSpace);
        indicatorMargin = (int) array.getDimension(com.yyydjk.library.R.styleable.BannerLayoutStyle_indicatorMargin, indicatorMargin);
        autoPlayDuration = array.getInt(com.yyydjk.library.R.styleable.BannerLayoutStyle_autoPlayDuration, autoPlayDuration);
        scrollDuration = array.getInt(com.yyydjk.library.R.styleable.BannerLayoutStyle_scrollDuration, scrollDuration);
        isAutoPlay = array.getBoolean(com.yyydjk.library.R.styleable.BannerLayoutStyle_isAutoPlay, isAutoPlay);
        array.recycle();
